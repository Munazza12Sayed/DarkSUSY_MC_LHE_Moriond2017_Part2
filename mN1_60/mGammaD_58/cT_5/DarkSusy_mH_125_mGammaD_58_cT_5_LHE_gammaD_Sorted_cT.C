...
//=========  (Tue Nov 29 05:50:19 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03720767,25.9375,0.2490052);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2289703);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1274738);
   h_gammaD_1_cT->SetBinContent(2,0.04691283);
   h_gammaD_1_cT->SetBinContent(3,0.01717185);
   h_gammaD_1_cT->SetBinContent(4,0.006373881);
   h_gammaD_1_cT->SetBinContent(5,0.002067616);
   h_gammaD_1_cT->SetBinContent(6,0.001436689);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1272057);
   h_gammaD_2_cT->SetBinContent(2,0.04653636);
   h_gammaD_2_cT->SetBinContent(3,0.01743689);
   h_gammaD_2_cT->SetBinContent(4,0.006317549);
   h_gammaD_2_cT->SetBinContent(5,0.002503467);
   h_gammaD_2_cT->SetBinContent(6,0.001337208);
