...
//=========  (Tue Nov 29 21:05:35 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001861802,518.75,0.01245975);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01145724);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006349768);
   h_gammaD_1_cT->SetBinContent(2,0.002354903);
   h_gammaD_1_cT->SetBinContent(3,0.0008648533);
   h_gammaD_1_cT->SetBinContent(4,0.0003161856);
   h_gammaD_1_cT->SetBinContent(5,0.00011429);
   h_gammaD_1_cT->SetBinContent(6,6.948028e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006365135);
   h_gammaD_2_cT->SetBinContent(2,0.00235001);
   h_gammaD_2_cT->SetBinContent(3,0.0008571572);
   h_gammaD_2_cT->SetBinContent(4,0.0003047614);
   h_gammaD_2_cT->SetBinContent(5,0.0001229364);
   h_gammaD_2_cT->SetBinContent(6,6.631266e-05);
