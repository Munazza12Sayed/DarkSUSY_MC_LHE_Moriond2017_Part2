...
//=========  (Tue Nov 29 21:17:11 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001860363,518.75,0.01245012);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01144839);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006344751);
   h_gammaD_1_cT->SetBinContent(2,0.002349129);
   h_gammaD_1_cT->SetBinContent(3,0.0008552698);
   h_gammaD_1_cT->SetBinContent(4,0.0003290467);
   h_gammaD_1_cT->SetBinContent(5,0.0001218039);
   h_gammaD_1_cT->SetBinContent(6,6.631266e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006360216);
   h_gammaD_2_cT->SetBinContent(2,0.002335879);
   h_gammaD_2_cT->SetBinContent(3,0.0008717865);
   h_gammaD_2_cT->SetBinContent(4,0.0003163498);
   h_gammaD_2_cT->SetBinContent(5,0.0001157684);
   h_gammaD_2_cT->SetBinContent(6,6.669267e-05);
