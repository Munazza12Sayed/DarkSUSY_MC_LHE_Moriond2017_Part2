...
//=========  (Tue Nov 29 21:13:14 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03717128,25.9375,0.2487617);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2287464);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1279149);
   h_gammaD_1_cT->SetBinContent(2,0.04626662);
   h_gammaD_1_cT->SetBinContent(3,0.01719332);
   h_gammaD_1_cT->SetBinContent(4,0.006372958);
   h_gammaD_1_cT->SetBinContent(5,0.002252184);
   h_gammaD_1_cT->SetBinContent(6,0.001287505);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1270813);
   h_gammaD_2_cT->SetBinContent(2,0.04681983);
   h_gammaD_2_cT->SetBinContent(3,0.01753986);
   h_gammaD_2_cT->SetBinContent(4,0.006202611);
   h_gammaD_2_cT->SetBinContent(5,0.002356384);
   h_gammaD_2_cT->SetBinContent(6,0.001429033);
