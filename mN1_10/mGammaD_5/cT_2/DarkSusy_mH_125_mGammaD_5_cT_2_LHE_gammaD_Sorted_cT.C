...
//=========  (Tue Nov 29 05:06:39 2016) by ROOT version5.34/36
   ...
   cnv->Range(-2.125,-0.09343549,10.375,0.6252991);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5749877);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3180169);
   h_gammaD_1_cT->SetBinContent(2,0.1174811);
   h_gammaD_1_cT->SetBinContent(3,0.04316602);
   h_gammaD_1_cT->SetBinContent(4,0.0152563);
   h_gammaD_1_cT->SetBinContent(5,0.00607972);
   h_gammaD_1_cT->SetBinContent(6,0.00346734);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3194376);
   h_gammaD_2_cT->SetBinContent(2,0.1174952);
   h_gammaD_2_cT->SetBinContent(3,0.0414404);
   h_gammaD_2_cT->SetBinContent(4,0.01592109);
   h_gammaD_2_cT->SetBinContent(5,0.005705768);
