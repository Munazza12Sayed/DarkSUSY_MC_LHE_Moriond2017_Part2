...
//=========  (Tue Nov 29 05:09:51 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03718231,25.9375,0.2488354);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2288142);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1272285);
   h_gammaD_1_cT->SetBinContent(2,0.04695424);
   h_gammaD_1_cT->SetBinContent(3,0.01699242);
   h_gammaD_1_cT->SetBinContent(4,0.006488499);
   h_gammaD_1_cT->SetBinContent(5,0.002336315);
   h_gammaD_1_cT->SetBinContent(6,0.001337208);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.127119);
   h_gammaD_2_cT->SetBinContent(2,0.04707492);
   h_gammaD_2_cT->SetBinContent(3,0.01718379);
   h_gammaD_2_cT->SetBinContent(4,0.006289069);
   h_gammaD_2_cT->SetBinContent(5,0.002333226);
   h_gammaD_2_cT->SetBinContent(6,0.001398415);
