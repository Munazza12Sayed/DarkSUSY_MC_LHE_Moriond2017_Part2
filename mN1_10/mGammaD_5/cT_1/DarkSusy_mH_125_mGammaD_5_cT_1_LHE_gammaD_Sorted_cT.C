...
//=========  (Tue Nov 29 05:01:03 2016) by ROOT version5.34/36
   ...
   cnv->Range(-1.0625,-0.1850849,5.1875,1.238645);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.138984);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6377555);
   h_gammaD_1_cT->SetBinContent(2,0.23317);
   h_gammaD_1_cT->SetBinContent(3,0.08572677);
   h_gammaD_1_cT->SetBinContent(4,0.03242535);
   h_gammaD_1_cT->SetBinContent(5,0.01092242);
   h_gammaD_1_cT->SetBinContent(6,0.006743409);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.632769);
   h_gammaD_2_cT->SetBinContent(2,0.2354215);
   h_gammaD_2_cT->SetBinContent(3,0.0877273);
   h_gammaD_2_cT->SetBinContent(4,0.03222558);
   h_gammaD_2_cT->SetBinContent(5,0.01185658);
   h_gammaD_2_cT->SetBinContent(6,0.007030345);
