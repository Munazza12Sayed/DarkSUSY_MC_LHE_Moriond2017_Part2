...
//=========  (Tue Nov 29 23:09:33 2016) by ROOT version5.34/36
   ...
   cnv->Range(-21.25,-0.00932248,103.75,0.06238891);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05736911);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03185709);
   h_gammaD_1_cT->SetBinContent(2,0.01171032);
   h_gammaD_1_cT->SetBinContent(3,0.004213501);
   h_gammaD_1_cT->SetBinContent(4,0.001613025);
   h_gammaD_1_cT->SetBinContent(5,0.0006060644);
   h_gammaD_1_cT->SetBinContent(6,0.0003474014);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03187173);
   h_gammaD_2_cT->SetBinContent(2,0.01155356);
   h_gammaD_2_cT->SetBinContent(3,0.004367826);
   h_gammaD_2_cT->SetBinContent(4,0.001590818);
   h_gammaD_2_cT->SetBinContent(5,0.0006160642);
