...
//=========  (Tue Nov 29 04:58:22 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001865663,518.75,0.01248559);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01148101);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.00634363);
   h_gammaD_1_cT->SetBinContent(2,0.002346524);
   h_gammaD_1_cT->SetBinContent(3,0.000879396);
   h_gammaD_1_cT->SetBinContent(4,0.0003211073);
   h_gammaD_1_cT->SetBinContent(5,0.0001093426);
   h_gammaD_1_cT->SetBinContent(6,6.593268e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006378336);
   h_gammaD_2_cT->SetBinContent(2,0.002343052);
   h_gammaD_2_cT->SetBinContent(3,0.0008581963);
   h_gammaD_2_cT->SetBinContent(4,0.0003098063);
   h_gammaD_2_cT->SetBinContent(5,0.0001106092);
