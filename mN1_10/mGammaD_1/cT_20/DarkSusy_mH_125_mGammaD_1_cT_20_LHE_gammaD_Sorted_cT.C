...
//=========  (Tue Nov 29 04:09:45 2016) by ROOT version5.34/36
   ...
   cnv->Range(-21.25,-0.009298586,103.75,0.062229);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05722207);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03185822);
   h_gammaD_1_cT->SetBinContent(2,0.01168531);
   h_gammaD_1_cT->SetBinContent(3,0.004311441);
   h_gammaD_1_cT->SetBinContent(4,0.001578093);
   h_gammaD_1_cT->SetBinContent(5,0.0005669305);
   h_gammaD_1_cT->SetBinContent(6,0.0003372639);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03179004);
   h_gammaD_2_cT->SetBinContent(2,0.0117207);
   h_gammaD_2_cT->SetBinContent(3,0.004371901);
   h_gammaD_2_cT->SetBinContent(4,0.001581888);
   h_gammaD_2_cT->SetBinContent(5,0.0005354761);
   h_gammaD_2_cT->SetBinContent(6,0.0003378974);
