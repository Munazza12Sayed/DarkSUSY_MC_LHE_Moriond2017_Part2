...
//=========  (Tue Nov 29 04:06:11 2016) by ROOT version5.34/36
   ...
   cnv->Range(-1.0625,-0.1854711,5.1875,1.24123);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.141361);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6378387);
   h_gammaD_1_cT->SetBinContent(2,0.2333283);
   h_gammaD_1_cT->SetBinContent(3,0.08652202);
   h_gammaD_1_cT->SetBinContent(4,0.03077859);
   h_gammaD_1_cT->SetBinContent(5,0.01153247);
   h_gammaD_1_cT->SetBinContent(6,0.006934681);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6340894);
   h_gammaD_2_cT->SetBinContent(2,0.2351075);
   h_gammaD_2_cT->SetBinContent(3,0.08793025);
   h_gammaD_2_cT->SetBinContent(4,0.0305258);
   h_gammaD_2_cT->SetBinContent(5,0.01234709);
   h_gammaD_2_cT->SetBinContent(6,0.006743409);
