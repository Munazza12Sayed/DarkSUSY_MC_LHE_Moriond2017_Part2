...
//=========  (Tue Nov 29 04:12:56 2016) by ROOT version5.34/36
   ...
   cnv->Range(-2.125,-0.09274681,10.375,0.6206902);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5707496);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3171827);
   h_gammaD_1_cT->SetBinContent(2,0.1183321);
   h_gammaD_1_cT->SetBinContent(3,0.04304711);
   h_gammaD_1_cT->SetBinContent(4,0.01558701);
   h_gammaD_1_cT->SetBinContent(5,0.005851064);
   h_gammaD_1_cT->SetBinContent(6,0.003409954);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3170831);
   h_gammaD_2_cT->SetBinContent(2,0.1187578);
   h_gammaD_2_cT->SetBinContent(3,0.04309232);
   h_gammaD_2_cT->SetBinContent(4,0.01548437);
   h_gammaD_2_cT->SetBinContent(5,0.005582349);
   h_gammaD_2_cT->SetBinContent(6,0.003161432);
