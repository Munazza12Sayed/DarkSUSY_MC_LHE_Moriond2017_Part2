...
//=========  (Tue Nov 29 04:15:46 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03728128,25.9375,0.2494978);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2294233);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1270009);
   h_gammaD_1_cT->SetBinContent(2,0.04660423);
   h_gammaD_1_cT->SetBinContent(3,0.01739395);
   h_gammaD_1_cT->SetBinContent(4,0.006493284);
   h_gammaD_1_cT->SetBinContent(5,0.002507646);
   h_gammaD_1_cT->SetBinContent(6,0.001367807);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1274574);
   h_gammaD_2_cT->SetBinContent(2,0.04650518);
   h_gammaD_2_cT->SetBinContent(3,0.01726337);
   h_gammaD_2_cT->SetBinContent(4,0.006423934);
   h_gammaD_2_cT->SetBinContent(5,0.002350127);
   h_gammaD_2_cT->SetBinContent(6,0.001218725);
