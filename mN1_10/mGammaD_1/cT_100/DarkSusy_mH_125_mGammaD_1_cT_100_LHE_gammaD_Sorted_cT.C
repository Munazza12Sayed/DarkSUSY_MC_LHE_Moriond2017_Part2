...
//=========  (Tue Nov 29 04:02:07 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001859924,518.75,0.01244718);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01144568);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006376635);
   h_gammaD_1_cT->SetBinContent(2,0.002306831);
   h_gammaD_1_cT->SetBinContent(3,0.0008796617);
   h_gammaD_1_cT->SetBinContent(4,0.0003193163);
   h_gammaD_1_cT->SetBinContent(5,0.0001175567);
   h_gammaD_1_cT->SetBinContent(6,6.897333e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006358713);
   h_gammaD_2_cT->SetBinContent(2,0.002331184);
   h_gammaD_2_cT->SetBinContent(3,0.0008626552);
   h_gammaD_2_cT->SetBinContent(4,0.0003205047);
   h_gammaD_2_cT->SetBinContent(5,0.0001269426);
   h_gammaD_2_cT->SetBinContent(6,7.46795e-05);
