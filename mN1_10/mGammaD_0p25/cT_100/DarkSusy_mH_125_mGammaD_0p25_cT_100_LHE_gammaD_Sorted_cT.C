...
//=========  (Tue Nov 29 02:38:33 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001870604,518.75,0.01251866);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01151141);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006370275);
   h_gammaD_1_cT->SetBinContent(2,0.002331218);
   h_gammaD_1_cT->SetBinContent(3,0.0008656292);
   h_gammaD_1_cT->SetBinContent(4,0.000315152);
   h_gammaD_1_cT->SetBinContent(5,0.0001177256);
   h_gammaD_1_cT->SetBinContent(6,7.26499e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006395229);
   h_gammaD_2_cT->SetBinContent(2,0.002316867);
   h_gammaD_2_cT->SetBinContent(3,0.0008567151);
   h_gammaD_2_cT->SetBinContent(4,0.000314175);
   h_gammaD_2_cT->SetBinContent(5,0.0001170135);
   h_gammaD_2_cT->SetBinContent(6,6.555273e-05);
