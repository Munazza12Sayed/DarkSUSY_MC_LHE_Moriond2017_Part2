...
//=========  (Tue Nov 29 02:20:09 2016) by ROOT version5.34/36
   ...
   cnv->Range(-0.053125,-3.712658,0.259375,24.84625);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.84713);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.74226);
   h_gammaD_1_cT->SetBinContent(2,4.688106);
   h_gammaD_1_cT->SetBinContent(3,1.707053);
   h_gammaD_1_cT->SetBinContent(4,0.6378803);
   h_gammaD_1_cT->SetBinContent(5,0.224705);
   h_gammaD_1_cT->SetBinContent(6,0.1300924);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.69285);
   h_gammaD_2_cT->SetBinContent(2,4.697076);
   h_gammaD_2_cT->SetBinContent(3,1.713128);
   h_gammaD_2_cT->SetBinContent(4,0.6569214);
   h_gammaD_2_cT->SetBinContent(5,0.2400241);
   h_gammaD_2_cT->SetBinContent(6,0.12756);
