...
//=========  (Tue Nov 29 02:29:24 2016) by ROOT version5.34/36
   ...
   cnv->Range(-0.10625,-1.866502,0.51875,12.49121);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.48617);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.360948);
   h_gammaD_1_cT->SetBinContent(2,2.360017);
   h_gammaD_1_cT->SetBinContent(3,0.8494602);
   h_gammaD_1_cT->SetBinContent(4,0.3172107);
   h_gammaD_1_cT->SetBinContent(5,0.1123638);
   h_gammaD_1_cT->SetBinContent(6,0.06605934);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.381204);
   h_gammaD_2_cT->SetBinContent(2,2.314651);
   h_gammaD_2_cT->SetBinContent(3,0.8619236);
   h_gammaD_2_cT->SetBinContent(4,0.3244637);
   h_gammaD_2_cT->SetBinContent(5,0.1177581);
   h_gammaD_2_cT->SetBinContent(6,0.06466629);
