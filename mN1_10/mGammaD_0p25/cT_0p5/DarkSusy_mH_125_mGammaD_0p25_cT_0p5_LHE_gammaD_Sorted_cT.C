...
//=========  (Tue Nov 29 02:33:31 2016) by ROOT version5.34/36
   ...
   cnv->Range(-0.53125,-0.371698,2.59375,2.487518);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.287373);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.272608);
   h_gammaD_1_cT->SetBinContent(2,0.4684687);
   h_gammaD_1_cT->SetBinContent(3,0.1727832);
   h_gammaD_1_cT->SetBinContent(4,0.06254642);
   h_gammaD_1_cT->SetBinContent(5,0.0235934);
   h_gammaD_1_cT->SetBinContent(6,0.01435244);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.270763);
   h_gammaD_2_cT->SetBinContent(2,0.4688656);
   h_gammaD_2_cT->SetBinContent(3,0.1734722);
   h_gammaD_2_cT->SetBinContent(4,0.06352681);
   h_gammaD_2_cT->SetBinContent(5,0.02337283);
   h_gammaD_2_cT->SetBinContent(6,0.01270536);
