...
//=========  (Tue Nov 29 02:42:03 2016) by ROOT version5.34/36
   ...
   cnv->Range(-1.0625,-0.186,5.1875,1.244769);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.144616);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6352376);
   h_gammaD_1_cT->SetBinContent(2,0.2365066);
   h_gammaD_1_cT->SetBinContent(3,0.08600414);
   h_gammaD_1_cT->SetBinContent(4,0.03051086);
   h_gammaD_1_cT->SetBinContent(5,0.01174079);
   h_gammaD_1_cT->SetBinContent(6,0.006877291);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6358975);
   h_gammaD_2_cT->SetBinContent(2,0.2341771);
   h_gammaD_2_cT->SetBinContent(3,0.08670553);
   h_gammaD_2_cT->SetBinContent(4,0.03192116);
   h_gammaD_2_cT->SetBinContent(5,0.01129868);
   h_gammaD_2_cT->SetBinContent(6,0.006418412);
