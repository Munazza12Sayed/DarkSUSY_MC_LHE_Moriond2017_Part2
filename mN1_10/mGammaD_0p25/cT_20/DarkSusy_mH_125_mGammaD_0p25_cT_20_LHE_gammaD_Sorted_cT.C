...
//=========  (Tue Nov 29 02:46:12 2016) by ROOT version5.34/36
   ...
   cnv->Range(-21.25,-0.009327025,103.75,0.06241933);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05739708);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.0318005);
   h_gammaD_1_cT->SetBinContent(2,0.01166232);
   h_gammaD_1_cT->SetBinContent(3,0.004387058);
   h_gammaD_1_cT->SetBinContent(4,0.001564289);
   h_gammaD_1_cT->SetBinContent(5,0.000585822);
   h_gammaD_1_cT->SetBinContent(6,0.0003385308);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03188727);
   h_gammaD_2_cT->SetBinContent(2,0.01164444);
   h_gammaD_2_cT->SetBinContent(3,0.004303598);
   h_gammaD_2_cT->SetBinContent(4,0.001580901);
   h_gammaD_2_cT->SetBinContent(5,0.0005837947);
   h_gammaD_2_cT->SetBinContent(6,0.0003264972);
