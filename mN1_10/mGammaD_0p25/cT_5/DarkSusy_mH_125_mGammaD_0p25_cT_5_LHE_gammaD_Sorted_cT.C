...
//=========  (Tue Nov 29 02:52:46 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03739382,25.9375,0.250251);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2301159);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1280287);
   h_gammaD_1_cT->SetBinContent(2,0.04588383);
   h_gammaD_1_cT->SetBinContent(3,0.01725867);
   h_gammaD_1_cT->SetBinContent(4,0.006340463);
   h_gammaD_1_cT->SetBinContent(5,0.002488318);
   h_gammaD_1_cT->SetBinContent(6,0.001341033);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1278421);
   h_gammaD_2_cT->SetBinContent(2,0.04641623);
   h_gammaD_2_cT->SetBinContent(3,0.0171459);
   h_gammaD_2_cT->SetBinContent(4,0.006290121);
   h_gammaD_2_cT->SetBinContent(5,0.002305618);
   h_gammaD_2_cT->SetBinContent(6,0.001310442);
