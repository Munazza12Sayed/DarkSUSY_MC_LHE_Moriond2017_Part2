...
//=========  (Tue Nov 29 02:49:42 2016) by ROOT version5.34/36
   ...
   cnv->Range(-2.125,-0.09352674,10.375,0.6259097);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5755492);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.319407);
   h_gammaD_1_cT->SetBinContent(2,0.1162481);
   h_gammaD_1_cT->SetBinContent(3,0.04313718);
   h_gammaD_1_cT->SetBinContent(4,0.01563272);
   h_gammaD_1_cT->SetBinContent(5,0.005574972);
   h_gammaD_1_cT->SetBinContent(6,0.003352581);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3197495);
   h_gammaD_2_cT->SetBinContent(2,0.1163348);
   h_gammaD_2_cT->SetBinContent(3,0.04293668);
   h_gammaD_2_cT->SetBinContent(4,0.01505967);
   h_gammaD_2_cT->SetBinContent(5,0.005919352);
   h_gammaD_2_cT->SetBinContent(6,0.003563013);
