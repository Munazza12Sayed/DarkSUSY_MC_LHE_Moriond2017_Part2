...
//=========  (Tue Nov 29 01:22:11 2016) by ROOT version5.34/36
   TCanvas *cnv = new TCanvas("cnv", "cnv",1,1,904,904);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.2924927,10.375,1.957451);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(1.799955);
   ...
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.99985);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.0001500019);
   ...
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.999975);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,2.500031e-05);
