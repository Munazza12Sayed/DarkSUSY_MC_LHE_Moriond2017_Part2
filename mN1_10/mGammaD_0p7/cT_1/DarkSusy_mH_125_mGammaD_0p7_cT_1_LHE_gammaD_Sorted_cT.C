...
//=========  (Tue Nov 29 03:35:38 2016) by ROOT version5.34/36
   ...
   cnv->Range(-1.0625,-0.185739,5.1875,1.243023);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.14301);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6360734);
   h_gammaD_1_cT->SetBinContent(2,0.2343898);
   h_gammaD_1_cT->SetBinContent(3,0.08606012);
   h_gammaD_1_cT->SetBinContent(4,0.03215141);
   h_gammaD_1_cT->SetBinContent(5,0.0113252);
   h_gammaD_1_cT->SetBinContent(6,0.007087751);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6350053);
   h_gammaD_2_cT->SetBinContent(2,0.2352483);
   h_gammaD_2_cT->SetBinContent(3,0.08689626);
   h_gammaD_2_cT->SetBinContent(4,0.03066145);
   h_gammaD_2_cT->SetBinContent(5,0.01218864);
   h_gammaD_2_cT->SetBinContent(6,0.006208232);
