...
//=========  (Tue Nov 29 03:32:05 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001874067,518.75,0.01254184);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01153272);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006373467);
   h_gammaD_1_cT->SetBinContent(2,0.002318403);
   h_gammaD_1_cT->SetBinContent(3,0.0008736813);
   h_gammaD_1_cT->SetBinContent(4,0.0003206436);
   h_gammaD_1_cT->SetBinContent(5,0.0001138052);
   h_gammaD_1_cT->SetBinContent(6,7.112823e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006407068);
   h_gammaD_2_cT->SetBinContent(2,0.002307315);
   h_gammaD_2_cT->SetBinContent(3,0.0008544351);
   h_gammaD_2_cT->SetBinContent(4,0.0003209323);
   h_gammaD_2_cT->SetBinContent(5,0.0001102497);
   h_gammaD_2_cT->SetBinContent(6,6.833971e-05);
