...
//=========  (Tue Nov 29 03:40:35 2016) by ROOT version5.34/36
   ...
   cnv->Range(-21.25,-0.009301212,103.75,0.06224658);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05723823);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03176746);
   h_gammaD_1_cT->SetBinContent(2,0.01171387);
   h_gammaD_1_cT->SetBinContent(3,0.00436801);
   h_gammaD_1_cT->SetBinContent(4,0.001551197);
   h_gammaD_1_cT->SetBinContent(5,0.0005994691);
   h_gammaD_1_cT->SetBinContent(6,0.0003220652);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03179902);
   h_gammaD_2_cT->SetBinContent(2,0.01159263);
   h_gammaD_2_cT->SetBinContent(3,0.004355651);
   h_gammaD_2_cT->SetBinContent(4,0.001625975);
   h_gammaD_2_cT->SetBinContent(5,0.0006267304);
   h_gammaD_2_cT->SetBinContent(6,0.0003391644);
