...
//=========  (Tue Nov 29 03:47:41 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03736222,25.9375,0.2500395);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2299214);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1272603);
   h_gammaD_1_cT->SetBinContent(2,0.04669451);
   h_gammaD_1_cT->SetBinContent(3,0.01750902);
   h_gammaD_1_cT->SetBinContent(4,0.006105943);
   h_gammaD_1_cT->SetBinContent(5,0.002430226);
   h_gammaD_1_cT->SetBinContent(6,0.001249288);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1277341);
   h_gammaD_2_cT->SetBinContent(2,0.04625641);
   h_gammaD_2_cT->SetBinContent(3,0.01722697);
   h_gammaD_2_cT->SetBinContent(4,0.006442545);
   h_gammaD_2_cT->SetBinContent(5,0.002339981);
   h_gammaD_2_cT->SetBinContent(6,0.001325736);
