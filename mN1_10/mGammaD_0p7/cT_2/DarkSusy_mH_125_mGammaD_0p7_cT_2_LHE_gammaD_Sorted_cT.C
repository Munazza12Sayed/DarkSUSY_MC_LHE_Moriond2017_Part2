...
//=========  (Tue Nov 29 03:44:19 2016) by ROOT version5.34/36
   ...
   cnv->Range(-2.125,-0.09350924,10.375,0.6257927);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5754415);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3167844);
   h_gammaD_1_cT->SetBinContent(2,0.1188333);
   h_gammaD_1_cT->SetBinContent(3,0.04280126);
   h_gammaD_1_cT->SetBinContent(4,0.01561847);
   h_gammaD_1_cT->SetBinContent(5,0.005962553);
   h_gammaD_1_cT->SetBinContent(6,0.003199651);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3196898);
   h_gammaD_2_cT->SetBinContent(2,0.1158628);
   h_gammaD_2_cT->SetBinContent(3,0.04310755);
   h_gammaD_2_cT->SetBinContent(4,0.0156651);
   h_gammaD_2_cT->SetBinContent(5,0.005674797);
   h_gammaD_2_cT->SetBinContent(6,0.003783198);
