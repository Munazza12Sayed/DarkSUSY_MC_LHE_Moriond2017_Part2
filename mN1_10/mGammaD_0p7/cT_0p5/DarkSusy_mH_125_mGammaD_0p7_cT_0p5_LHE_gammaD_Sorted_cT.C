...
//=========  (Tue Nov 29 03:26:45 2016) by ROOT version5.34/36
   ...
   cnv->Range(-0.53125,-0.3717515,2.59375,2.487875);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.287701);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.26869);
   h_gammaD_1_cT->SetBinContent(2,0.4704817);
   h_gammaD_1_cT->SetBinContent(3,0.1748582);
   h_gammaD_1_cT->SetBinContent(4,0.06294894);
   h_gammaD_1_cT->SetBinContent(5,0.0230209);
   h_gammaD_1_cT->SetBinContent(6,0.01273068);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.270945);
   h_gammaD_2_cT->SetBinContent(2,0.4657214);
   h_gammaD_2_cT->SetBinContent(3,0.175564);
   h_gammaD_2_cT->SetBinContent(4,0.06444307);
   h_gammaD_2_cT->SetBinContent(5,0.02332633);
   h_gammaD_2_cT->SetBinContent(6,0.01303456);
