...
//=========  (Tue Nov 29 23:31:29 2016) by ROOT version5.34/36
   ...
   cnv->Range(-2.125,-0.09264565,10.375,0.6200132);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5701271);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3188319);
   h_gammaD_1_cT->SetBinContent(2,0.1165527);
   h_gammaD_1_cT->SetBinContent(3,0.04315289);
   h_gammaD_1_cT->SetBinContent(4,0.01568851);
   h_gammaD_1_cT->SetBinContent(5,0.005773979);
   h_gammaD_1_cT->SetBinContent(6,0.00331434);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3167373);
   h_gammaD_2_cT->SetBinContent(2,0.1180784);
   h_gammaD_2_cT->SetBinContent(3,0.04384249);
   h_gammaD_2_cT->SetBinContent(4,0.01578557);
   h_gammaD_2_cT->SetBinContent(5,0.005556294);
   h_gammaD_2_cT->SetBinContent(6,0.003381266);
