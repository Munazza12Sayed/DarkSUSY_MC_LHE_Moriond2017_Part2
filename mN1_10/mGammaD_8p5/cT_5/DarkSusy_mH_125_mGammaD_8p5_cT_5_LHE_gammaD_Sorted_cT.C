...
//=========  (Tue Nov 29 05:29:43 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03723444,25.9375,0.2491844);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2291351);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1266227);
   h_gammaD_1_cT->SetBinContent(2,0.04694641);
   h_gammaD_1_cT->SetBinContent(3,0.01738503);
   h_gammaD_1_cT->SetBinContent(4,0.006656155);
   h_gammaD_1_cT->SetBinContent(5,0.002389682);
   h_gammaD_1_cT->SetBinContent(6,0.001352506);
   h_gammaD_1_cT->SetEntries(52999);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1272973);
   h_gammaD_2_cT->SetBinContent(2,0.04655104);
   h_gammaD_2_cT->SetBinContent(3,0.01730656);
   h_gammaD_2_cT->SetBinContent(4,0.006470487);
   h_gammaD_2_cT->SetBinContent(5,0.002374665);
   h_gammaD_2_cT->SetBinContent(6,0.001367807);
   h_gammaD_2_cT->SetEntries(52999);
