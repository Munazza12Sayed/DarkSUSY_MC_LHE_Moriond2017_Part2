...
//=========  (Thu Dec 15 01:35:12 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001855563,518.75,0.012418);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01141885);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006376447);
   h_gammaD_1_cT->SetBinContent(2,0.002317564);
   h_gammaD_1_cT->SetBinContent(3,0.0008774534);
   h_gammaD_1_cT->SetBinContent(4,0.0003180674);
   h_gammaD_1_cT->SetBinContent(5,0.000110468);
   h_gammaD_1_cT->SetBinContent(6,6.56769e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006343807);
   h_gammaD_2_cT->SetBinContent(2,0.002361438);
   h_gammaD_2_cT->SetBinContent(3,0.0008609029);
   h_gammaD_2_cT->SetBinContent(4,0.0003182419);
   h_gammaD_2_cT->SetBinContent(5,0.0001156099);
   h_gammaD_2_cT->SetBinContent(6,7.518418e-05);
