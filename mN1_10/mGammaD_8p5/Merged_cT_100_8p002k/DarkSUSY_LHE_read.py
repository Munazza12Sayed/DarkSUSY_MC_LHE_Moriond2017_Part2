...
filename = "/eos/user/w/wshi/DarkSUSYMC_LHE_Moriond2017_Part2/Merged_LHE/DarkSUSY_mH_125_mN1_10_mGammaD_8p5_13TeV_cT_100_madgraph452_bridge224_events1500k.lhe"
f = open(filename, 'r')
#==================================
...
n1Mass = "10"
mass_GammaD = "8p5" #pure string
mass_GammaD_Legend = "8.5" #numerical string
...
h_n1_1_M_dummy = ROOT.TH1F("h_n1_1_M_dummy", "h_n1_1_M_dummy", 120, 0.05, 120.05)
h_n1_1_M_dummy.SetYTitle("Fraction of events / 1 GeV")
...
h_n1_1_M = ROOT.TH1F("h_n1_1_M", "h_n1_1_M", 120, 0.05, 120.05)
...
h_gammaD_1_M_dummy.SetYTitle("Fraction of events / 1 GeV")
...
h_dimuon_1_M_dummy = ROOT.TH1F("h_dimuon_1_M_dummy", "h_dimuon_1_M_dummy", 500, 0.005, 100.005)
...
h_dimuon_1_M = ROOT.TH1F("h_dimuon_1_M", "h_dimuon_1_M", 500, 0.005, 100.005)
