...
//=========  (Tue Nov 29 05:20:51 2016) by ROOT version5.34/36
   ...
   cnv->Range(-1.0625,-0.1867751,5.1875,1.249956);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.149385);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6400395);
   h_gammaD_1_cT->SetBinContent(2,0.2353924);
   h_gammaD_1_cT->SetBinContent(3,0.08307073);
   h_gammaD_1_cT->SetBinContent(4,0.03008846);
   h_gammaD_1_cT->SetBinContent(5,0.01140894);
   h_gammaD_1_cT->SetBinContent(6,0.006093625);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6385474);
   h_gammaD_2_cT->SetBinContent(2,0.2319036);
   h_gammaD_2_cT->SetBinContent(3,0.08574524);
   h_gammaD_2_cT->SetBinContent(4,0.03162236);
   h_gammaD_2_cT->SetBinContent(5,0.01218145);
   h_gammaD_2_cT->SetBinContent(6,0.007183444);
