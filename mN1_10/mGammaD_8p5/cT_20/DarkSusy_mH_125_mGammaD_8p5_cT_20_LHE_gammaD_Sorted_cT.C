...
//=========  (Tue Nov 29 23:29:01 2016) by ROOT version5.34/36
   ...
   cnv->Range(-21.25,-0.009307822,103.75,0.06229081);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05727891);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03177935);
   h_gammaD_1_cT->SetBinContent(2,0.011765);
   h_gammaD_1_cT->SetBinContent(3,0.004290136);
   h_gammaD_1_cT->SetBinContent(4,0.001576007);
   h_gammaD_1_cT->SetBinContent(5,0.0005895084);
   h_gammaD_1_cT->SetBinContent(6,0.00033093);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03182162);
   h_gammaD_2_cT->SetBinContent(2,0.0115997);
   h_gammaD_2_cT->SetBinContent(3,0.00441306);
   h_gammaD_2_cT->SetBinContent(4,0.001551998);
   h_gammaD_2_cT->SetBinContent(5,0.0006136243);
