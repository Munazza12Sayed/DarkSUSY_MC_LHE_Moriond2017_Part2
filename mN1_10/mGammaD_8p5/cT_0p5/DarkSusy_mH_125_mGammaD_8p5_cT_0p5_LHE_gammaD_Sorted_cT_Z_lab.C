...
//=========  (Tue Nov 29 23:21:08 2016) by ROOT version5.34/36
   ...
   cnv->Range(-0.53125,-0.2167177,2.59375,1.450342);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(1.333648);
   ...
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.7352592);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.4706668);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.3448753);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.2510388);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.1981599);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,1.957212);
   ...
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.7409154);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.4763061);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.3362861);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.2478926);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.1985998);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,1.81002);
