...
//=========  (Tue Nov 29 05:18:21 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001865193,518.75,0.01248244);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01147811);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006370592);
   h_gammaD_1_cT->SetBinContent(2,0.002337218);
   h_gammaD_1_cT->SetBinContent(3,0.0008650676);
   h_gammaD_1_cT->SetBinContent(4,0.0003147416);
   h_gammaD_1_cT->SetBinContent(5,0.0001123808);
   h_gammaD_1_cT->SetBinContent(6,6.757947e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006376727);
   h_gammaD_2_cT->SetBinContent(2,0.00233831);
   h_gammaD_2_cT->SetBinContent(3,0.0008550892);
   h_gammaD_2_cT->SetBinContent(4,0.0003135621);
   h_gammaD_2_cT->SetBinContent(5,0.0001163113);
   h_gammaD_2_cT->SetBinContent(6,7.011405e-05);
