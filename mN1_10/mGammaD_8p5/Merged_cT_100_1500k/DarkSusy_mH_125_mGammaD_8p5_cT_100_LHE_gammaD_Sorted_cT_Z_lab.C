...
//=========  (Thu Dec 15 02:36:00 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001083956,518.75,0.007254166);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(0.006670497);
   ...
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.003643516);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.002391573);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.001686092);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.001271418);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.001007401);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,0.009729514);
   h_gammaD_1_cT_Z_lab->SetEntries(1469979);
   ...
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.003705832);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.002379037);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.001670958);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.001254771);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.0009894021);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.009065851);
   h_gammaD_2_cT_Z_lab->SetEntries(1469979);
