...
//=========  (Thu Dec 15 02:35:59 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001864468,518.75,0.01247759);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01147365);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006364042);
   h_gammaD_1_cT->SetBinContent(2,0.002338972);
   h_gammaD_1_cT->SetBinContent(3,0.0008654015);
   h_gammaD_1_cT->SetBinContent(4,0.000316108);
   h_gammaD_1_cT->SetBinContent(5,0.0001154764);
   h_gammaD_1_cT->SetBinContent(6,6.808037e-05);
   h_gammaD_1_cT->SetEntries(1469979);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006374249);
   h_gammaD_2_cT->SetBinContent(2,0.002330293);
   h_gammaD_2_cT->SetBinContent(3,0.0008620336);
   h_gammaD_2_cT->SetBinContent(4,0.0003162874);
   h_gammaD_2_cT->SetBinContent(5,0.0001171369);
   h_gammaD_2_cT->SetBinContent(6,6.834242e-05);
   h_gammaD_2_cT->SetEntries(1469979);
