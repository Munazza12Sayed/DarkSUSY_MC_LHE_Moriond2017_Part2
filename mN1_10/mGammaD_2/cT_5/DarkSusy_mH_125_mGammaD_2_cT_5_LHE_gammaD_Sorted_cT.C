...
//=========  (Tue Nov 29 04:48:52 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03737497,25.9375,0.2501248);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2299998);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1279327);
   h_gammaD_1_cT->SetBinContent(2,0.04658107);
   h_gammaD_1_cT->SetBinContent(3,0.01686674);
   h_gammaD_1_cT->SetBinContent(4,0.006146482);
   h_gammaD_1_cT->SetBinContent(5,0.002473028);
   h_gammaD_1_cT->SetBinContent(6,0.001333384);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1277777);
   h_gammaD_2_cT->SetBinContent(2,0.04608892);
   h_gammaD_2_cT->SetBinContent(3,0.01740833);
   h_gammaD_2_cT->SetBinContent(4,0.006314749);
   h_gammaD_2_cT->SetBinContent(5,0.002410326);
   h_gammaD_2_cT->SetBinContent(6,0.001490296);
