...
//=========  (Tue Nov 29 04:34:16 2016) by ROOT version5.34/36
   ...
   cnv->Range(-0.53125,-0.3741522,2.59375,2.503942);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.302475);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.275695);
   h_gammaD_1_cT->SetBinContent(2,0.4652959);
   h_gammaD_1_cT->SetBinContent(3,0.1737971);
   h_gammaD_1_cT->SetBinContent(4,0.06218543);
   h_gammaD_1_cT->SetBinContent(5,0.02302698);
   h_gammaD_1_cT->SetBinContent(6,0.01326253);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.279153);
   h_gammaD_2_cT->SetBinContent(2,0.4634503);
   h_gammaD_2_cT->SetBinContent(3,0.1720344);
   h_gammaD_2_cT->SetBinContent(4,0.06363156);
   h_gammaD_2_cT->SetBinContent(5,0.02173092);
   h_gammaD_2_cT->SetBinContent(6,0.01442852);
