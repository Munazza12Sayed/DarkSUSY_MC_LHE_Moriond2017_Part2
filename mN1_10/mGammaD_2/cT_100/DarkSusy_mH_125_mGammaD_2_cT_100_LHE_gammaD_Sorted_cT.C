...
//=========  (Tue Nov 29 04:37:35 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001860517,518.75,0.01245115);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01144934);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006381616);
   h_gammaD_1_cT->SetBinContent(2,0.002345533);
   h_gammaD_1_cT->SetBinContent(3,0.0008572902);
   h_gammaD_1_cT->SetBinContent(4,0.0002989318);
   h_gammaD_1_cT->SetBinContent(5,0.0001166287);
   h_gammaD_1_cT->SetBinContent(6,6.491954e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006360743);
   h_gammaD_2_cT->SetBinContent(2,0.002366504);
   h_gammaD_2_cT->SetBinContent(3,0.0008458181);
   h_gammaD_2_cT->SetBinContent(4,0.0003156094);
   h_gammaD_2_cT->SetBinContent(5,0.000111325);
   h_gammaD_2_cT->SetBinContent(6,6.314704e-05);
