...
//=========  (Tue Nov 29 04:42:26 2016) by ROOT version5.34/36
   ...
   cnv->Range(-21.25,-0.009361833,103.75,0.06265227);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05761128);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03192685);
   h_gammaD_1_cT->SetBinContent(2,0.01167382);
   h_gammaD_1_cT->SetBinContent(3,0.004263497);
   h_gammaD_1_cT->SetBinContent(4,0.001558312);
   h_gammaD_1_cT->SetBinContent(5,0.0005775256);
   h_gammaD_1_cT->SetBinContent(6,0.0003283969);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03200627);
   h_gammaD_2_cT->SetBinContent(2,0.01155535);
   h_gammaD_2_cT->SetBinContent(3,0.004281975);
   h_gammaD_2_cT->SetBinContent(4,0.00158002);
   h_gammaD_2_cT->SetBinContent(5,0.0005763834);
   h_gammaD_2_cT->SetBinContent(6,0.0003385308);
