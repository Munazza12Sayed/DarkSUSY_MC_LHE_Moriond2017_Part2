...
//=========  (Tue Nov 29 04:39:45 2016) by ROOT version5.34/36
   ...
   cnv->Range(-1.0625,-0.186856,5.1875,1.250498);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.149883);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6390071);
   h_gammaD_1_cT->SetBinContent(2,0.2339702);
   h_gammaD_1_cT->SetBinContent(3,0.08478311);
   h_gammaD_1_cT->SetBinContent(4,0.03099597);
   h_gammaD_1_cT->SetBinContent(5,0.01124364);
   h_gammaD_1_cT->SetBinContent(6,0.006590443);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6388239);
   h_gammaD_2_cT->SetBinContent(2,0.2330616);
   h_gammaD_2_cT->SetBinContent(3,0.08527662);
   h_gammaD_2_cT->SetBinContent(4,0.03135869);
   h_gammaD_2_cT->SetBinContent(5,0.01147918);
   h_gammaD_2_cT->SetBinContent(6,0.007260011);
