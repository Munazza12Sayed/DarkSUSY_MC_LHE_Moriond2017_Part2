...
//=========  (Tue Nov 29 04:46:33 2016) by ROOT version5.34/36
   ...
   cnv->Range(-2.125,-0.09343379,10.375,0.6252877);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5749772);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3172337);
   h_gammaD_1_cT->SetBinContent(2,0.1169621);
   h_gammaD_1_cT->SetBinContent(3,0.04450903);
   h_gammaD_1_cT->SetBinContent(4,0.01535875);
   h_gammaD_1_cT->SetBinContent(5,0.005936437);
   h_gammaD_1_cT->SetBinContent(6,0.003400391);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3194318);
   h_gammaD_2_cT->SetBinContent(2,0.1169477);
   h_gammaD_2_cT->SetBinContent(3,0.0424643);
   h_gammaD_2_cT->SetBinContent(4,0.0155063);
   h_gammaD_2_cT->SetBinContent(5,0.005649879);
   h_gammaD_2_cT->SetBinContent(6,0.003256989);
