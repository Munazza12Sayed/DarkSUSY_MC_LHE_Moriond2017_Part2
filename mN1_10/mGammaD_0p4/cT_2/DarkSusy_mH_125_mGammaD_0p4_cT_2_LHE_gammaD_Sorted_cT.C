...
//=========  (Tue Nov 29 03:15:55 2016) by ROOT version5.34/36
   ...
   cnv->Range(-2.125,-0.09294662,10.375,0.6220274);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5719792);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3182664);
   h_gammaD_1_cT->SetBinContent(2,0.1172086);
   h_gammaD_1_cT->SetBinContent(3,0.04281726);
   h_gammaD_1_cT->SetBinContent(4,0.01589623);
   h_gammaD_1_cT->SetBinContent(5,0.005811524);
   h_gammaD_1_cT->SetBinContent(6,0.003276104);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3177662);
   h_gammaD_2_cT->SetBinContent(2,0.1169147);
   h_gammaD_2_cT->SetBinContent(3,0.04347);
   h_gammaD_2_cT->SetBinContent(4,0.01563361);
   h_gammaD_2_cT->SetBinContent(5,0.00621543);
   h_gammaD_2_cT->SetBinContent(6,0.003687442);
