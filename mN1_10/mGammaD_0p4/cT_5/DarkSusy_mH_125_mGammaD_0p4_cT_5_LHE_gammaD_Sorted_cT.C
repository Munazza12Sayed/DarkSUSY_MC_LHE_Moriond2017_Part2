...
//=========  (Tue Nov 29 03:18:53 2016) by ROOT version5.34/36
   ...
   cnv->Range(-5.3125,-0.03732833,25.9375,0.2498127);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2297128);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1267498);
   h_gammaD_1_cT->SetBinContent(2,0.04742382);
   h_gammaD_1_cT->SetBinContent(3,0.01712136);
   h_gammaD_1_cT->SetBinContent(4,0.00630747);
   h_gammaD_1_cT->SetBinContent(5,0.002397599);
   h_gammaD_1_cT->SetBinContent(6,0.001379284);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1276182);
   h_gammaD_2_cT->SetBinContent(2,0.04693331);
   h_gammaD_2_cT->SetBinContent(3,0.01673152);
   h_gammaD_2_cT->SetBinContent(4,0.006306118);
   h_gammaD_2_cT->SetBinContent(5,0.002410828);
   h_gammaD_2_cT->SetBinContent(6,0.001214905);
