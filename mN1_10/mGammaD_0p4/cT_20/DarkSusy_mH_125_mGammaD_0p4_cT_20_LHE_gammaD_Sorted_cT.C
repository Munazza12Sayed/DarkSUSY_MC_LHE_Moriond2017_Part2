...
//=========  (Tue Nov 29 03:12:24 2016) by ROOT version5.34/36
   ...
   cnv->Range(-21.25,-0.009300912,103.75,0.06224457);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05723638);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03185622);
   h_gammaD_1_cT->SetBinContent(2,0.0116799);
   h_gammaD_1_cT->SetBinContent(3,0.004313025);
   h_gammaD_1_cT->SetBinContent(4,0.001566256);
   h_gammaD_1_cT->SetBinContent(5,0.0005845929);
   h_gammaD_1_cT->SetBinContent(6,0.000341065);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03179799);
   h_gammaD_2_cT->SetBinContent(2,0.01165568);
   h_gammaD_2_cT->SetBinContent(3,0.004407842);
   h_gammaD_2_cT->SetBinContent(4,0.001534503);
   h_gammaD_2_cT->SetBinContent(5,0.0006039863);
   h_gammaD_2_cT->SetBinContent(6,0.0003315633);
