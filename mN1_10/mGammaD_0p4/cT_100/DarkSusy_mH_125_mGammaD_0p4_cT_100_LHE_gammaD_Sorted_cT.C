...
//=========  (Tue Nov 29 03:04:22 2016) by ROOT version5.34/36
   ...
   cnv->Range(-106.25,-0.001869099,518.75,0.01250858);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01150215);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006359298);
   h_gammaD_1_cT->SetBinContent(2,0.002357511);
   h_gammaD_1_cT->SetBinContent(3,0.0008488297);
   h_gammaD_1_cT->SetBinContent(4,0.000319161);
   h_gammaD_1_cT->SetBinContent(5,0.0001152001);
   h_gammaD_1_cT->SetBinContent(6,7.201581e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006390081);
   h_gammaD_2_cT->SetBinContent(2,0.002308979);
   h_gammaD_2_cT->SetBinContent(3,0.0008586958);
   h_gammaD_2_cT->SetBinContent(4,0.0003166794);
   h_gammaD_2_cT->SetBinContent(5,0.0001255646);
   h_gammaD_2_cT->SetBinContent(6,6.517281e-05);
