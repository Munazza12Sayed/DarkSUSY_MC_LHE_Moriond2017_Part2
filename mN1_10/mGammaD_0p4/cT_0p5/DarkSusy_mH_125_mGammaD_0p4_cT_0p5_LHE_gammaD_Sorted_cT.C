...
//=========  (Tue Nov 29 03:00:34 2016) by ROOT version5.34/36
   ...
   cnv->Range(-0.53125,-0.37149,2.59375,2.486125);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.286092);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.273411);
   h_gammaD_1_cT->SetBinContent(2,0.4663789);
   h_gammaD_1_cT->SetBinContent(3,0.1740269);
   h_gammaD_1_cT->SetBinContent(4,0.06247247);
   h_gammaD_1_cT->SetBinContent(5,0.02371034);
   h_gammaD_1_cT->SetBinContent(6,0.01359192);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.270051);
   h_gammaD_2_cT->SetBinContent(2,0.4648787);
   h_gammaD_2_cT->SetBinContent(3,0.1745748);
   h_gammaD_2_cT->SetBinContent(4,0.06664486);
   h_gammaD_2_cT->SetBinContent(5,0.02385026);
