...
//=========  (Tue Nov 29 03:07:27 2016) by ROOT version5.34/36
   ...
   cnv->Range(-1.0625,-0.1855711,5.1875,1.241899);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.141976);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6347677);
   h_gammaD_1_cT->SetBinContent(2,0.2368006);
   h_gammaD_1_cT->SetBinContent(3,0.08526646);
   h_gammaD_1_cT->SetBinContent(4,0.03130997);
   h_gammaD_1_cT->SetBinContent(5,0.01185523);
   h_gammaD_1_cT->SetBinContent(6,0.006915551);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6344311);
   h_gammaD_2_cT->SetBinContent(2,0.2362722);
   h_gammaD_2_cT->SetBinContent(3,0.08569802);
   h_gammaD_2_cT->SetBinContent(4,0.03164088);
   h_gammaD_2_cT->SetBinContent(5,0.01195786);
   h_gammaD_2_cT->SetBinContent(6,0.005959951);
